...
@section('content')
    <div class="card mt-5">
        ...
        <div class="card-header">
          <h4 class="text-center" style="font-family:Arial Black" >Ubah Pengumuman</h4>
        </div>
        <div class="card-body">
            <div class="row">
                         ...
                         <div class="row">
                            <div class="col-xs-11 col-sm-11 col-md-11">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="judul" value="{{ $pengumuman->judul }}" class="form-control" placeholder="Judul">
                                </div>
                            </div>
                            <div class="col-xs-11 col-sm-11 col-md-11">
                                <div class="form-group">
                                    <strong style="font-family: Arial black">Isi:</strong>
                                    <textarea class="form-control" style="height:150px" name="isi" id="editor" placeholder="Isi">{{ $pengumuman->isi }}</textarea>
                                </div>
                            </div>
                            <div class="col-xs-11 col-sm-11 col-md-11">

...
@endif
<h4 class="text-center" style="font-family:Arial Black" >Form Data Renungan</h4>
     ...
     <div class="row">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11">
            <div class="form-group">
                ...
                <textarea name="isi" id="editor" class="form-control" placeholder="Isi" cols="30" rows="10"></textarea>
            </div>
        </div>
        <div class="col-xs-11 col-sm-11 col-md-11">

...
@endif
  <h4 class="text-center" style="font-family:Arial Black" >Form Informasi Terbaru</h4>

<form action="{{ route('berita-terbaru.store') }}" method="POST" enctype="multipart/form-data">
    @csrf

...
@section('content')
    ...
    @endif
    <h4 class="text-center" style="font-family:Arial Black" >Ubah Foto</h4>
         ...
         <div class="row">
            <div class="col-xs-11 col-sm-11 col-md-11">
                <div class="form-group">
                    ...
                    <input type="text" name="judul" value="{{ $foto->judul }}" class="form-control" placeholder="Name">
                </div>
            </div>
            <div class="col-xs-11 col-sm-11 col-md-11">
                <div class="form-group">
                    <strong style="font-family:Arial black">Isi:</strong>
                    <textarea class="form-control" id="editor" style="height:150px" name="isi" placeholder="Isi">{{ $foto->isi }}</textarea>
                </div>
            </div>
            <div class="col-xs-11 col-sm-11 col-md-11">
                <div class="form-group">
                    ...
                    <img src="/image/{{ $foto->image }}" width="200px">
                </div>
            </div>
            <div class="col-xs-11 col-sm-11 col-md-11 ">

...
@endif
  <h4 class="text-center" style="font-family:Arial Black" >Form Berita Duka</h4>

<form action="{{ route('berita-duka.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
     ...
     <div class="row">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11">
            <div class="form-group">
                ...
                <textarea class="form-control" style="height:150px" id="editor" name="isi" placeholder="Isi"></textarea>
            </div>
        </div>
        <div class="col-xs-11 col-sm-11 col-md-11">
            <div class="form-group">

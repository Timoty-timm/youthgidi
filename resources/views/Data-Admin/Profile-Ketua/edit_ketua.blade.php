...
@section('content')
    ...
    @endif
    <h4 class="text-center" style="font-family:Arial Black" >Ubah Profile Sekertaris Pemuda GIDI</h4>
    <form action="{{ url('sprofile/update_ketua',$profil->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')

...
<br>
<h3 class="text-center" style="font-family:Arial Black" >Form Data Iuran Wajib</h3>
...
<form action="{{ url('kiuran/store_iuran') }}" method="POST" enctype="multipart/form-data">
    @csrf
     ...
     <div class="row">
        ...
        <div class="col-xs-10 col-sm-10 col-md-10">
            <div class="form-group">
                ...
                <select id="" placeholder="" name="wilayah" class="form-control" >
        ...
        <div class="col-xs-10 col-sm-10 col-md-10">
            <div class="form-group">
                ...
                <input type="text" placeholder="Nominal" name="nominal" class="form-control" placeholder="Nominal">
            </div>
        </div>
        <div class="col-xs-10 col-sm-10 col-md-10">
            <div class="form-group">
                <strong style="font-family: Arial, black" >Upload Bukti Transaksi:</strong>
                <input type="file" placeholder="Bukti Transaksi" name="image" class="form-control" placeholder="image">
            </div>
        </div>
        <div class="col-xs-10 col-sm-10 col-md-10">

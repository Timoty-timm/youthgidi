...
@section('content')
<div class="card">
  <div class="card-header"> <a href="{{ url('anggotapemuda') }}">Home</a> {{ __('/ Struktur Organisasi') }}</div>
    <hr>
</div>
<div class="row text-center" >
  <h4 class="text-center" style="font-family:Arial Black" > Struktur Organisasi Pemuda GIDI</h4>

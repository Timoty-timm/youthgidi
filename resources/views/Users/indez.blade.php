  ...
  <div class="site-wrap">
    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container">
       ...
       <a href="images/gidi.jpg"><img src="images/logogidi.jpg"  width="90px" heigth="90px" /></a> 
        </div> 
        <div class="col-2 col-xl-9">
        
        <a href="#home-section" class="h2 mb-0" img src="images/logogidi.jpg"  width="100px" heigth="90px" >Sistem Informasi Pemuda GIDI<span class="text-primary">.</span> </a></h1>
        </div> 
          <div class="col-6 col-xl-2">
            <a href="images/logogidi.jpg"><img src="images/logogidi.jpg"  width="90px" heigth="600px" /></a>
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    <li><a href="#team-section" class="nav-link">Visi & Misi</a></li>
                    <li><a href="#pricing-section" class="nav-link">Struktur Organisasi</a></li>
                    <li><a href="#faq-section" class="nav-link">Sejarah</a></li>
                    <!-- <li class="has-children">
                      <a href="#">More Links</a>
                      <ul class="dropdown">
                ...
                <li><a href="#portfolio-section" class="nav-link">Kengiatan</a></li>
                <li><a href="#services-section" class="nav-link">Iuran Wajib</a></li>
                <li><a href="#testimonials-section" class="nav-link">Renungan Harian</a></li>
                <li class="has-children">
                  <a href="#about-section" class="nav-link">Galeri</a>
                  <ul class="dropdown">
                    <li><a href="#team-section" class="nav-link">Video</a></li>
                    <li><a href="#pricing-section" class="nav-link">Foto</a></li>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          ...
          <div class="col-md-8 mt-lg-5 text-center">
            ...
            <p class="mb-5 desc"  data-aos="fade-up" data-aos-delay="100">Sistem Informasi Pemuda (GIDI)</p>
            <div data-aos="fade-up" data-aos-delay="100">
              <a href="#contact-section" class="btn smoothscroll btn-primary mr-2 mb-2">Melihat Kontak
                 </a>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center" data-aos="fade">
            <h2 class="section-title mb-3">Ketua Pusat Pemuda GIDI</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
            <figure class="circle-bg">
            <img src="images/ketuapusat.png" alt="Image" class="img-fluid">
            </figure>
            <b>EV. Yandinus Mabel S.TH</b>
          </div>
      ...
      <div class="container">
        ...
        <div class="row mb-5 justify-content-center">
          <div class="col-md-7 text-center">
            <h2 class="section-title mb-3" data-aos="fade-up" data-aos-delay="">Berita Sekarang</h2>
        ...
        <div class="row" >
          <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
            ...
            <div class="owl-carousel slide-one-item-alt">
              <img src="images/gidi4.jpg" alt="Image" class="img-fluid">
              <img src="images/images2.jpg" alt="Image" class="img-fluid">
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-8 text-center">
            <h2 class="section-title mb-3" data-aos="fade-up" data-aos-delay="">Pengurus Pusat</h2>
            <p class="lead" data-aos="fade-up" data-aos-delay="100">Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus minima neque tempora reiciendis.</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="100">
            <div class="team-member">
              <figure>
                ...
                @foreach ($data as $product)
                <img  src="/image/{{ $product->image }}" alt="Image" class="img-fluid">
                @endforeach
              </figure>
              <div class="p-3">
                <h3>Dave Simpson</h3>
          ...
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member">
              <figure>
                ...
                <!-- @foreach ($data as $product)
                <img {{ ++$i }} src="/image/{{ $product->image }}" alt="Image" class="img-fluid">
                @endforeach -->
              </figure>
              <div class="p-3">
                <h3>Ben Thompson</h3>
    ...
    <section class="site-section" id="portfolio-section">
      ...
      <div class="container">
        ...
        <div class="row mb-3">
          <div class="col-12 text-center" data-aos="fade">
            <h2 class="section-title mb-3">Foto</h2>
          </div>
        </div>

        <div class="row justify-content-center mb-5" data-aos="fade-up">
          <div id="filters" class="filters text-center button-group col-md-7">
            <button class="btn btn-primary active" data-filter="*">Semua Foto</button>
            <button class="btn btn-primary" data-filter=".web">Pengurus Wilayah</button>
            <button class="btn btn-primary" data-filter=".design">Pengurus Klasis</button>
            <button class="btn btn-primary" data-filter=".brand">Pengurus Ketua Pemuda</button>
          </div>
        </div>  
        
<!-- <h1 >Makasih Semuanya atas doa dan dukungan </h1> -->

        
        <div id="posts" class="row no-gutter">
          <div class="item web col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4">
            @foreach($data as $Product)
            <a href="/image/{{ $product->image }}" alt="Image" class="item-wrap fancybox" data-fancybox="gallery2">
              @endforeach
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            <h2 class="section-title mb-3">Renungan Harian</h2>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center" data-aos="fade-up">
            <h2 class="section-title mb-3">Kengiatan</h2>
          </div>
        </div>
        <div class="row mb-5">
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-4 text-center">
            <p class="mb-4">
              ...
              <span>Institut Teknologe Del</span>
            </p>
          </div>
          <div class="col-md-4 text-center">
            <p class="mb-4">
              <span class="icon-phone d-block h4 text-primary"></span>
              <a href="#">+6285244824720</a>
            </p>
          </div>
          <div class="col-md-4 text-center">
            <p class="mb-0">
              <span class="icon-mail_outline d-block h4 text-primary"></span>
              <a href="#">timironkogoya@domain.com</a>
            </p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12 mb-5">
            ...
            <form action="#" class="p-5 bg-white">
              ...
              <h2 class="h4 text-black mb-5">Kontak Form</h2> 
